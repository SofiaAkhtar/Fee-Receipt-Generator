...
public class fee extends Frame {
        ...
        fee() {
                ...
                universityLabel = new JLabel("C.V RAMAN GLOBAL UNIVERSITY  ", SwingConstants.CENTER);
                universityLabel.setBounds(330, 50, 900, 30); // Adjust position and size as needed
                universityLabel.setFont(new Font("Bebas Neue", Font.BOLD, 30)); // Adjust font and size as needed
                universityLabel.setForeground(Color.YELLOW);
                add(universityLabel);

                JLabel additionalLabel = new JLabel(
                                "                                               ODISHA BHUBNESWAR  INDIA");
                additionalLabel.setBounds(330, 80, 1500, 30); // Adjust position and size as needed
                additionalLabel.setFont(new Font("Arial", Font.BOLD, 20)); // Adjust font and size as needed
                add(additionalLabel);

                l1 = new JLabel("                               FEE REPORT");
                l1.setBounds(550, 110, 250, 20);
                ...
                String language[] = { "2020", "2021", "2022" };
                ...
                String languagess[] = { "2022", "2023", "2024" };
                ...
                rb1 = new JRadioButton("GROUP-1");
                rb1.setBounds(550, 150, 100, 30);

                rb2 = new JRadioButton("GROUP-2");
                rb2.setBounds(650, 150, 100, 30);

                rb3 = new JRadioButton("GROUP-3");
                rb3.setBounds(650, 150, 100, 30);

                rb4 = new JRadioButton("GROUP-4");
                rb4.setBounds(650, 150, 100, 30);
